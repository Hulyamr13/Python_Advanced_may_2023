-- Таблица "towns" с информация за градовете
CREATE TABLE towns (
    id SERIAL PRIMARY KEY,
    name VARCHAR(45) NOT NULL
);

-- Таблица "stadiums" с информация за стадионите
...
-- Таблица "teams" с информация за отборите
CREATE TABLE teams (
    id SERIAL PRIMARY KEY,
    name VARCHAR(45) NOT NULL,
...
-- Таблица "coaches" с информация за треньорите
...
-- Таблица "skills_data" с информация за уменията на играчите
...
-- Таблица "players" с информация за играчите
...
-- Таблица "players_coaches" с връзка между играчи и треньори
