...
-- Create the "animal_types" table
CREATE TABLE animal_types (
    id SERIAL PRIMARY KEY,
    animal_type VARCHAR(30) NOT NULL
);

-- Create the "cages" table with a foreign key constraint
CREATE TABLE cages (
    id SERIAL PRIMARY KEY,
...
-- Create the "animals" table with foreign key constraints
...
-- Create the "volunteers_departments" table
CREATE TABLE volunteers_departments (
    id SERIAL PRIMARY KEY,
    department_name VARCHAR(30) NOT NULL
);

-- Create the "volunteers" table with foreign key constraints
...
-- Create the "animals_cages" table with foreign key constraints
